...
{
    public partial class peli4 : Form
    {
        bool vuoro = false;
        ...
        private void peli4_Load(object sender, EventArgs e)
        {

        }

        private void yksinpeliToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
        ...
        private void peli4_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
